...
uploadRoutes.get('/uploads/driver-license', getDriverLicenseUploads)

// Get uploads by specific user
uploadRoutes.get('/uploads/driver-license/user/:userId', getDriverLicenseUploadsByUser)

// Get upload statistics (admin only)
uploadRoutes.get('/uploads/driver-license/stats', getUploadStats)

// Verify license (admin only)
uploadRoutes.patch('/uploads/driver-license/:uploadId/verify', verifyDriverLicense)
